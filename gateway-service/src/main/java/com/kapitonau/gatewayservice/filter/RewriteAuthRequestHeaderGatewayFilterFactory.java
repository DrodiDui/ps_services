package com.kapitonau.gatewayservice.filter;
...
@Component
public class RewriteAuthRequestHeaderGatewayFilterFactory extends AbstractGatewayFilterFactory<RewriteAuthRequestHeaderGatewayFilterFactory.Config> {

    private final AuthTokenStore authTokenStore;

    public RewriteAuthRequestHeaderGatewayFilterFactory(AuthTokenStore authTokenStore) {
        super(Config.class);
            ...
            if (headers.containsKey(HttpHeaders.AUTHORIZATION)) {
                ...
                for (String headerValue : headerValues) {
                    if (headerValue.startsWith("Bearer ")) {
                        ...
                        authTokenValue = authTokenStore.getAuthToken(tokenId);
                    }
                }
            }
