...
public class TokenConfiguration {
    ...
    @Value("${security.jwt.keystore.filename}")
    private Resource keystoreFileName;
    ...
    public JWKSource<SecurityContext> jwkSource(KeyStoreKeyFactory keyStoreKeyFactory) {
        KeyPair keyPair = keyStoreKeyFactory.getKeyPair(keystoreAlias, keystorePass.toCharArray());
    ...
    public KeyStoreKeyFactory keyStoreKeyFactory() {
        return new KeyStoreKeyFactory(keystoreFileName, keystorePass.toCharArray(), "PKCS12");
    }
